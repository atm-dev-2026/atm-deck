-- CreateEnum
CREATE TYPE "BoardVisibility" AS ENUM ('GLOBAL', 'DEPARTMENT', 'PERSONAL');

-- CreateEnum
CREATE TYPE "BoardRole" AS ENUM ('READ_ONLY', 'CAN_EDIT');
...
CREATE TABLE "Board" (
    "id" TEXT NOT NULL,
    "name" TEXT NOT NULL,
    "visibilityType" "BoardVisibility" NOT NULL DEFAULT 'PERSONAL',
...
CREATE TABLE "BoardMember" (
    ...
    "role" "BoardRole" NOT NULL DEFAULT 'READ_ONLY',
...
-- CreateIndex
CREATE INDEX "Message_channelId_parentId_updatedAt_idx" ON "Message"("channelId", "parentId", "updatedAt");
